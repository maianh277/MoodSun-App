...
const ResetPasswordScreen = () => {
  ...
  return (
    <View style={tw`mt-12 px-4 py-2 bg-white`}>
      ...
      <Text style={tw` mb-6`}>Please input your phone to recover your password</Text>
      ...
      <TextInput 
        ...
        value={phone}
      />
      <LoginButton onLoginPress={() => console.log('Login pressed')} buttonText="Continue" />
      
      <View style={tw`absolute bottom-10 right-10 w-5 h-5 bg-yellow-500 rounded-full`}></View>
      <View style={tw`absolute bottom-50 right-20 w-10 h-10 bg-yellow-500 rounded-full`}></View>
